...
realineada (#86) y la 05 con su hover (#87). Abiertos: la 06 en `claude/seccion-06-precio` (#88) y
la 07 en `claude/seccion-07-preguntas`. Los dos salen de `main` y tocan el mismo sitio de este
archivo, así que el segundo en fusionarse dará conflicto aquí — en `index.html` no, que son secciones
distintas.
